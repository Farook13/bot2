...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1002289409354').split()]
...
MAIN_CHANNEL = environ.get('MAIN_CHANNEL' "-1002289409354")
FILE_FORWARD = environ.get('FILE_FORWARD')
MSG_ALRT = environ.get('MSG_ALRT', '𝑪𝑯𝑬𝑪𝑲 & 𝑻𝑹𝒀 𝑨𝑳𝑳 𝑴𝒀 𝑭𝑬𝑨𝑻𝑼𝑹𝑬𝑺')
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', '0'))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002289409354'))                           
